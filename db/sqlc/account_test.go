...
import (
	...
	"github.com/egespindola/go-api-bank/util"
	"github.com/stretchr/testify/require"
)

// createRandomAccount is a helper function to create random account and disacouple the tests
...
func TestGetAcc(t *testing.T) {
	...
	require.WithinDuration(t, account.CreatedAt, acc.CreatedAt, time.Second)
